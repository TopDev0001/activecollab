...
abstract class BaseExpense extends ApplicationObject implements ITrash, IHistory, IActivityLog, ITrackingObject, IWhoCanSeeThis, ActiveCollab\Foundation\Urls\Router\Context\RoutingContextInterface, IChild, ICreatedOn, ICreatedBy, IUpdatedOn, IUpdatedBy
{
    ...
    const MANAGER_NAME = 'Expenses';

    protected string $table_name = 'expenses';
