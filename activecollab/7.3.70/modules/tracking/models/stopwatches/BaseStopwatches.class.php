...
abstract class BaseStopwatches extends DataManager
{
    /**
    ...
    /**
     * @return Stopwatch[]|DbResult|null
     */
    ...
    public static function findOne($arguments = null): ?Stopwatch
    {
    ...
    public static function findOneBy($field, $value = null): ?Stopwatch
    {
