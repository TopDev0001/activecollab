...
abstract class BaseBudgetThresholdsNotifications extends DataManager
{
    /**
    ...
    {
        return 'budget_thresholds_notifications';
    }
    ...
    {
        return BudgetThresholdsNotification::class;
    }
    ...
    /**
     * @return BudgetThresholdsNotification[]|DbResult|null
     */
    ...
    public static function findOne($arguments = null): ?BudgetThresholdsNotification
    {
    ...
    public static function findOneBy($field, $value = null): ?BudgetThresholdsNotification
    {
    ...
    /**
     * @return BudgetThresholdsNotification[]
     */
    ...
    /**
     * @return BudgetThresholdsNotification|bool
     */
