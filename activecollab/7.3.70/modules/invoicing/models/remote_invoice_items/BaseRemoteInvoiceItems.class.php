...
abstract class BaseRemoteInvoiceItems extends DataManager
{
    ...
    {
        return RemoteInvoiceItem::class;
    }
    ...
    /**
     * @return RemoteInvoiceItem[]|DbResult|null
     */
    ...
    public static function findOne($arguments = null): ?RemoteInvoiceItem
    {
    ...
    public static function findOneBy($field, $value = null): ?RemoteInvoiceItem
    {
