...
abstract class BaseRemoteInvoices extends DataManager
{
    /**
    ...
    /**
     * @return RemoteInvoice[]|DbResult|null
     */
    ...
    public static function findOne($arguments = null): ?RemoteInvoice
    {
    ...
    public static function findOneBy($field, $value = null): ?RemoteInvoice
    {
