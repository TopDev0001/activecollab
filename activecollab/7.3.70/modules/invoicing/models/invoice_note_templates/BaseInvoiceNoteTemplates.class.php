...
abstract class BaseInvoiceNoteTemplates extends DataManager
{
    ...
    {
        return InvoiceNoteTemplate::class;
    }
    ...
    /**
     * @return InvoiceNoteTemplate[]|DbResult|null
     */
    ...
    public static function findOne($arguments = null): ?InvoiceNoteTemplate
    {
    ...
    public static function findOneBy($field, $value = null): ?InvoiceNoteTemplate
    {
