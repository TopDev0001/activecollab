...
abstract class BaseTestDataObjects extends DataManager
{
    ...
    /**
     * @return TestDataObject[]|DbResult|null
     */
    ...
    public static function findOne($arguments = null): ?TestDataObject
    {
    ...
    public static function findOneBy($field, $value = null): ?TestDataObject
    {
