...
abstract class BaseUserInvitations extends DataManager
{
    /**
    ...
    /**
     * @return UserInvitation[]|DbResult|null
     */
    ...
    public static function findOne($arguments = null): ?UserInvitation
    {
    ...
    public static function findOneBy($field, $value = null): ?UserInvitation
    {
