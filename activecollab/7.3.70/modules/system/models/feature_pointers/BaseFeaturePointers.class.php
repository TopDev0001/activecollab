...
abstract class BaseFeaturePointers extends DataManager
{
    /**
    ...
    /**
     * @return FeaturePointer[]|DbResult|null
     */
    ...
    public static function findOne($arguments = null): ?FeaturePointer
    {
    ...
    public static function findOneBy($field, $value = null): ?FeaturePointer
    {
