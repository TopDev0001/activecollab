...
abstract class BaseAvailabilityTypes extends DataManager
{
    ...
    /**
     * @return AvailabilityType[]|DbResult|null
     */
    ...
    public static function findOne($arguments = null): ?AvailabilityType
    {
    ...
    public static function findOneBy($field, $value = null): ?AvailabilityType
    {
