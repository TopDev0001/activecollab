...
abstract class BaseProjectTemplateTaskDependencies extends DataManager
{
    /**
    ...
    {
        return 'project_template_task_dependencies';
    }
    ...
    {
        return ProjectTemplateTaskDependency::class;
    }
    ...
    /**
     * @return ProjectTemplateTaskDependency[]|DbResult|null
     */
    ...
    public static function findOne($arguments = null): ?ProjectTemplateTaskDependency
    {
    ...
    public static function findOneBy($field, $value = null): ?ProjectTemplateTaskDependency
    {
    ...
    /**
     * @return ProjectTemplateTaskDependency[]
     */
    ...
    /**
     * @return ProjectTemplateTaskDependency|bool
     */
