...
abstract class BaseProjectTemplateTaskDependency extends ApplicationObject implements ICreatedOn
{
    ...
    const MODEL_NAME = 'ProjectTemplateTaskDependency';
    const MANAGER_NAME = 'ProjectTemplateTaskDependencies';

    protected string $table_name = 'project_template_task_dependencies';
