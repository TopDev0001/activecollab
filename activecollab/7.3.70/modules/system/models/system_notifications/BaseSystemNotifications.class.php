...
abstract class BaseSystemNotifications extends DataManager
{
    ...
    public static function findOne($arguments = null): ?SystemNotification
    {
    ...
    public static function findOneBy($field, $value = null): ?SystemNotification
    {
    ...
    /**
     * @return SystemNotification|bool
     */
