...
abstract class BaseConversationUsers extends DataManager
{
    /**
    ...
    /**
     * @return ConversationUser[]|DbResult|null
     */
    ...
    public static function findOne($arguments = null): ?ConversationUser
    {
    ...
    public static function findOneBy($field, $value = null): ?ConversationUser
    {
