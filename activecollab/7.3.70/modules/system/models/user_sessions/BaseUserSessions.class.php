...
abstract class BaseUserSessions extends DataManager
{
    /**
    ...
    /**
     * @return UserSession[]|DbResult|null
     */
    ...
    public static function findOne($arguments = null): ?UserSession
    {
    ...
    public static function findOneBy($field, $value = null): ?UserSession
    {
