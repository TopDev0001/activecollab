...
abstract class BaseDataFilters extends DataManager
{
    ...
    /**
     * @return DataFilter[]|DbResult|null
     */
    ...
    public static function findOne($arguments = null): ?DataFilter
    {
    ...
    public static function findOneBy($field, $value = null): ?DataFilter
    {
