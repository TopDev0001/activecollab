...
abstract class BaseReminders extends DataManager
{
    ...
    public static function findOne($arguments = null): ?Reminder
    {
    ...
    public static function findOneBy($field, $value = null): ?Reminder
    {
