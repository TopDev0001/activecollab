...
abstract class BaseSubscriptions extends DataManager
{
    /**
    ...
    /**
     * @return Subscription[]|DbResult|null
     */
    ...
    public static function findOne($arguments = null): ?Subscription
    {
    ...
    public static function findOneBy($field, $value = null): ?Subscription
    {
