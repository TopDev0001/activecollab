...
abstract class BaseReactions extends DataManager
{
    /**
    ...
    public static function findOne($arguments = null): ?Reaction
    {
    ...
    public static function findOneBy($field, $value = null): ?Reaction
    {
