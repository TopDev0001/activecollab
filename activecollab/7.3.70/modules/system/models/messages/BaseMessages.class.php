...
abstract class BaseMessages extends DataManager
{
    /**
    ...
    public static function findOne($arguments = null): ?Message
    {
    ...
    public static function findOneBy($field, $value = null): ?Message
    {
