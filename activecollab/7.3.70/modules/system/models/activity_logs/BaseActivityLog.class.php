...
abstract class BaseActivityLog extends ApplicationObject implements IWhoCanSeeThis, ActiveCollab\Foundation\Urls\Router\Context\RoutingContextInterface, IChild, ICreatedOn, ICreatedBy, IUpdatedOn, IAdditionalProperties
{
    ...
    const MANAGER_NAME = 'ActivityLogs';
    ...
    /**
     * Return value of parent_path field.
     *
     * @return string
     */
    public function getParentPath()
    {
        return $this->getFieldValue('parent_path');
    }

    /**
     * Set value of parent_path field.
     *
     * @param  string $value
     * @return string
     */
    public function setParentPath($value)
    {
        return $this->setFieldValue('parent_path', $value);
    }
