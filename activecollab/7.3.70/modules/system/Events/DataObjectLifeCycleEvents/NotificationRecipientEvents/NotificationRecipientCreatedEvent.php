...
class NotificationRecipientCreatedEvent extends NotificationRecipientLifeCycleEvent implements NotificationRecipientCreatedEventInterface
{
    use DataObjectLifeCycleWebhookEventTrait;

    public function getWebhookEventType(): string
    {
        return 'NotificationRecipientCreated';
    }
}
