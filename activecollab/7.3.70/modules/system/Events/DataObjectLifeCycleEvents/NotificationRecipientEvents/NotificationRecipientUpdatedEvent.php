...
class NotificationRecipientUpdatedEvent extends NotificationRecipientLifeCycleEvent implements NotificationRecipientCreatedEventInterface, BadgeCountChangedEventInterface
{
    use DataObjectLifeCycleWebhookEventTrait;

    public function getWebhookEventType(): string
    {
        return 'NotificationRecipientUpdated';
    }
}
