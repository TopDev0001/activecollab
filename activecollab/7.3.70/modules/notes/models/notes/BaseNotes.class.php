...
abstract class BaseNotes extends DataManager
{
    /**
    ...
    public static function findOne($arguments = null): ?Note
    {
    ...
    public static function findOneBy($field, $value = null): ?Note
    {
