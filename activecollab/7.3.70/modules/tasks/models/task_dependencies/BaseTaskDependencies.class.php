...
abstract class BaseTaskDependencies extends DataManager
{
    ...
    /**
     * @return TaskDependency[]|DbResult|null
     */
    ...
    public static function findOne($arguments = null): ?TaskDependency
    {
    ...
    public static function findOneBy($field, $value = null): ?TaskDependency
    {
